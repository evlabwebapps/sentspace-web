...
export default function FeatureInfo() {
    return (
        <Container>
            ...
            <p><strong>Language Model Surprisal</strong> (under construction). Language model surprisal provides a metric
                for how surprising (i.e., likely) a given sentence is by using the probability
                distribution obtained from pre-trained
            ...
            <p><strong>Syntactic Rule Frequency (under development)</strong>. The syntactic rule frequencies consist of counts of
                n-ary and binary syntactic rules. For both <em>n</em>-ary (n is an arbitrary number larger than two) and
